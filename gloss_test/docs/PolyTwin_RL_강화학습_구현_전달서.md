...
> **구버전/참고용:** 이 문서는 실제 실험·실측 GU 보정을 전제로 작성된 과거 전달서다.
> 현재 구현기준은 [`digital_twin/README.md`](digital_twin/README.md)에서 시작하는 새 문서 세트다.
> 새 프로젝트는 실제 실험으로 재보정하지 않고 논문 기반 Isaac Lab 디지털 트윈을 최종모델로 사용한다.
